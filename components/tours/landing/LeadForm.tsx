  ...
  return (
    <section id="lead-form" className="section bg-sand scroll-mt-24">
      <div className="mx-auto max-w-2xl px-6 md:px-10 lg:px-16">
        <SectionReveal>
          <div className="eyebrow text-center">Check availability</div>
          ...
          <p className="mt-3 text-center text-sm leading-6 text-ink/70">
            Share your month and group size — we reply on WhatsApp with
            availability, the full itinerary, and how to hold your slot.
          </p>
        </SectionReveal>
        ...
        >
          ...
          <button
            type="submit"
            className="cta-primary mt-6 flex min-h-[48px] w-full items-center justify-center gap-2 text-base font-semibold"
          >
            Check availability
